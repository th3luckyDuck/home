...
function generateColor(dot, dist)
{
	...
	var intensity = document.querySelector('#light3').getAttribute('intensity') / (dist * dist);
...
AFRAME.registerComponent('bake-vertex-light3', {
	schema: {
		light: {type: 'selector', default: '#light3'}
	},
	bake: function (object) 
	{
		...
		var pos = document.querySelector('#light3').getAttribute('position');
