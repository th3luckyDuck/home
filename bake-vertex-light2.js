...
function generateColor(dot, dist)
{
	...
	var intensity = document.querySelector('#light2').getAttribute('intensity') / (dist * dist);
...
AFRAME.registerComponent('bake-vertex-light2', {
	schema: {
		light: {type: 'selector', default: '#light2'}
	},
	bake: function (object) 
	{
		...
		var pos = document.querySelector('#light2').getAttribute('position');
